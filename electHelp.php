...
<ul id="css3menu1" class="topmenu">
	...
	<li class="toplast"><a href="#" style="width:135px;height:21px;line-height:21px;" id="active"><span><img src="__styles/menu/help.png" alt=""/>Electrol council</span></a>
	<ul>
  ...
  <div id="bo__dy" style="padding:20px;">
     <h3 style=" text-align:center;">If you want to vote using this best application there is order to follow:</h3>

<p style="text-align:justify; padding:30px; color:#999999;">To a new voter you first make your registration to the electoral canseil then you will get the permission of voting
then after inserting your all informtion then you're allowed to vote any candidate you want on the candidate list. Our application is the best to every body cause of modern voting strategy</p>
  </div>
